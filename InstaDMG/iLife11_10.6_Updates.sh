...
DATE=$(date "+%Y-%m-%d")
OUTPUT="$(PWD)/CatalogFiles/iLife11_10.6_Updates.catalog"
...
for i in DL1413 DL1414 DL1322 DL1514 DL1412 DL1507 DL1552
do
	TITLE=$(curl --silent ${BASE_URL}/kb/${i} | sed -En 's:^.*<h1 id="main-title">(.*)</h1>$:\1:p')
